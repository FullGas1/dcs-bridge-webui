...
| [`FEAT-BRANDING-HEADER-REDESIGN`](FEAT-BRANDING-HEADER-REDESIGN/PRD.md) | ready-for-agent | The banner reads as a thin technical diagram, not a product banner, and doesn't show what the tool does. Richer two-scene diagonal composition (flight + tactical-map motifs, still 100% original vector art, no DCS trademarked imagery) with a code-to-result signal crossing the seam. | — |
